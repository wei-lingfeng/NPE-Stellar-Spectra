...
with open(f'{data_path}/simulated_spectra.pkl', 'rb') as file:
...
if new_run:
    ...
    engine = nbi.NBI(
        ...
        labels=labels,
        device='cuda',
        path='/stow/weilingfeng/data/apogee/nbi_all_params'
        # n_jobs=16
    )
    ...
    with open(f'{data_path}/best_model_path.txt', 'w') as file:
        file.write(best_model)

else:
    with open(f'{data_path}/best_model_path.txt', 'r') as file:
